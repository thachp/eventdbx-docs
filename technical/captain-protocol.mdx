---
title: "Cap’n Proto"
description: "Deep dive into the Cap’n Proto transport protocol powering replication."
---

Captain is EventDBX’s replication protocol. It runs over TCP/TLS, multiplexes multiple streams, and keeps latency low even when nodes are far apart.

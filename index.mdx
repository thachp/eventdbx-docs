...
<CardGroup cols={3}>
  ...
  <Card title="Plugins" icon="shuffle" href="/plugins/overview">
    Learn how plugin instances consume the job queue, configure payload slices,
    and replay events.
  </Card>
  <Card
    title="CLI reference"
  ...
  >
    Browse every `dbx` command grouped by lifecycle, schemas, aggregates,
    events, plugins, and upgrades.
  </Card>
</CardGroup>
